...
const Reviews = () => {
    ...
    return (
        <section className='mx-auto flex flex-col w-full justify-center px-5 py-5 gap-10'>
            ...
            <article className='sm:w-3/4 md:w-2/3 flex flex-col items-center mx-auto gap-2 py-10 shadow-md hover:shadow-lg'>
                ...
                <p className='text-md text-emerald-400'>{job}</p>
